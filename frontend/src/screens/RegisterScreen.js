  ...
  return <div className="form">
    <form onSubmit={submitHandler} >
      <ul className="form-container">
        ...
        <li>
          <label htmlFor="rePassword">Re-Ingresa Password</label>
        ...
        <li>
          ...
          <Link to={redirect === "/" ? "signin" : "signin?redirect=" + redirect} className="button secondary text-center" >Ingresa!</Link>
